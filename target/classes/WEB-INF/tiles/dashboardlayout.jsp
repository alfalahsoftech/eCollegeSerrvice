...
<link href="${stylejs_url}/theme/scripts/plupload/js/jquery.plupload.queue/css/jquery.plupload.queue.css" rel="stylesheet" type="text/css" />
...
<script type='text/javascript' src='${js_url}/fullcalendar/jquery.min.js'></script>
<script type='text/javascript'
	src='${js_url}/fullcalendar/jquery-ui.custom.min.js'></script>
<link href="${js_url}/fullcalendar/fullcalendar.css" rel="stylesheet"
	type="text/css" />
<link href="${js_url}/fullcalendardemo/fullcalendar.print.css"
