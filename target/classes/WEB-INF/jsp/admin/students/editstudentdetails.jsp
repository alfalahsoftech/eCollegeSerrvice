						...
						<div class="row-form">
							...
							<div class="span9">
								<f:input type="text" name="lfno" path="lfno" id="lfno"
									maxlength="5" title="Enter LF Number"
									class="validate[required],custom[integer],maxSize[5]" />
							</div>
						</div>
						...
						<div class="row-form">
							...
							<div class="span9">
								<f:input type="text" path="firstName" id="firstName"
									maxlength="10"
									class="validate[required,minSize[4],maxSize[10],custom[onlyLetterSp]]" />
							</div>
						</div>
						<div class="row-form">
							<div class="span3">Middle Name:</div>
							<div class="span9">
								<f:input type="text" path="middleName" maxlength="10"
									placeholder="(Optional)" id="secondName"
									class="validate[minSize[1],maxSize[10],custom[onlyLetterSp]]" />
							</div>
						</div>
						<div class="row-form">
							<div class="span3">
							...
							<div class="span9">
								<f:input type="text" path="lastName" id="lastName"
									...
									class="validate[minSize[3],maxSize[10],custom[onlyLetterSp]]" />
							</div>
						</div>
						<div class="row-form">
							<div class="span3">
							...
							<div class="span9">
								<f:input type="text" path="fatherName" id="lastName"
									maxlength="20"
									class="validate[required,minSize[4],maxSize[20],custom[onlyLetterSp]]" />
							</div>
						</div>
						<div class="row-form">
							<div class="span3">
							...
							<div class="span9">
								<f:input type="text" path="guardianName" id="guardianName"
									maxlength="20"
									class="validate[minSize[4],maxSize[20],custom[onlyLetterSp]]" />
							</div>
						</div>
						<div class="row-form">
							<div class="span3">
						...
						<div class="row-form">
							...
							<div class="span9">
								<f:input type="text" name="rollno" path="rollno" id="rollno"
									maxlength="3" title="Enter Roll Number"
									class="validate[custom[integer],maxSize[3]]" />
							</div>
						</div>
