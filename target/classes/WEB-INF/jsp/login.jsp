...
<div id="wrap" style="margin-left: -270px;">
	<div id="top_logo">
		<img alt="App_fedena_logo" src="${img_url}/school.jpg">
	</div>
	...
	<div id="login_area_bg" style="margin-top: 20px;">
		...
		<form action="${baseurl}j_spring_security_check" method="post">
			<div style="margin: 0; padding: 0; display: inline">
				<input name="category" type="hidden" value="ROLE_ADMIN">
			</div>
		...
		<div id="footer" style="margin-top: 55px;">
			<div id="footer_logo">
				<div id="powered_by">
					Powered by <a target="_blank" href="http://alfalahtech.herokuapp.com/">Alafalah-Softech</a>
				</div>
			</div>
		</div>
	</div>
