				...
				<div class="block">
					...
					<div class="data-fluid">
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" name="admissionNo"
									placeholder="Enter Admission No.(Optional)" readonly="readonly"
						...
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" name="lfno" id="lfno" maxlength="5"
									value="${lfNO}">
							</div>
						</div>
						...
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" name="firstName" id="firstName"
									maxlength="10"
									class="validate[required,minSize[2],maxSize[10],custom[onlyLetterSp]]">
							</div>
						</div>
						<div class="row-form">
							<div class="span3">
							...
							<div class="span9">
								<input type="text" placeholder="(Optional)" name="middleName"
									maxlength="10" id="secondName"
									class="validate[minSize[1],maxSize[10]	]">
							</div>
						</div>
						<div class="row-form">
							<div class="span3">
						...
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" name="fatherName" id="lastName"
									maxlength="30"
									class="validate[required,minSize[4],maxSize[30],custom[onlyLetterSp]]">
							</div>
						</div>
						<div class="row-form">
							<div class="span3">
						...
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" name="guardianName" id="guardianName"
									maxlength="20"
									class="validate[minSize[4],maxSize[30],custom[onlyLetterSp]]">
							</div>
						</div>
						<div class="row-form">
							<div class="span3">
						...
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" name="rollno" id="rollno"
									class="validate[custom[integer],minSize[1],maxSize[3]]">
							</div>
						</div>
						<div class="row-form">
							<div class="span3">
