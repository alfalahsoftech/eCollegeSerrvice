				...
				<div class="block">
					...
					<div class="data-fluid">
						...
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" name="studentName" 	maxlength="30" class="validate[required,minSize[2],maxSize[30],custom[onlyLetterSp]]">
							</div>
						</div>
						<div class="row-form">
							<div class="span3">
						...
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" name="fatherName" id="firstName"
									maxlength="30" class="validate[required,minSize[2],maxSize[30],custom[onlyLetterSp]]">
							</div>
						</div>
						<div class="row-form">
